...
{
   for(int GyroCalibration_counter = 0; GyroCalibration_counter < 500; GyroCalibration_counter++){       //Create 500 loops
    if(GyroCalibration_counter % 15 == 0)digitalWrite(CALIB_LED, !digitalRead(CALIB_LED));   //Change the state of the LED every 15 loops to make the LED blink fast
