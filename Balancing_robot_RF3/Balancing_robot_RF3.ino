...
//byte startProg, low_bat;
boolean ProgStopped, low_bat,timingProblem;
...
float  pid_i_mem, pid_setpoint, gyro_input, pid_output, pid_last_d_error;
...
void setup(){
  Serial.begin(9600);                                                       //Start the serial port at 9600 kbps
      ...
      Serial.println(F("Last Modified Nov 6 2017"));
      //Serial.end();
